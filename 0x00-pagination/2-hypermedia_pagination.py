...
class Server:
    ...
    def get_hyper(self, page: int = 1, page_size: int = 10) -> Dict[str, Any]:
        """
        Returns a hypermedia representation of a requested page of baby names data.
        ...
        Returns:
            dict: A dictionary containing hypermedia information about the requested
                  page of baby names data, including the page number, page size,
                  total number of pages, data for the requested page, and links to
                  the previous and next pages (if applicable).
        """
        self.assert_positive_integer_type(page)
        self.assert_positive_integer_type(page_size)
